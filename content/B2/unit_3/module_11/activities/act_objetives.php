        ...
        <div class="col-flex-md5 col-flex-xs12 col-flex-sm7 col-center">
          <div class="row">
            ...
            <ul class="c-moduleObjetive-description browser-default">
              ...
              <li class="c-moduleObjetive-items">Understand additional information in communicative exchanges.</li>
              <li class="c-moduleObjetive-items">Take the initiative in an interaction.</li>
              <li class="c-moduleObjetive-items">Encourage others to continue with the conversation.</li>
            </ul>
          </div>
        </div>
      </div>
