      ...
      <div class="row-flex c-moduleObjetive">
        <div class="col-flex-md7 showTo-md">
          <figure class="c-figure-Rombo">
            <div class="c-figure-RomboRotate"><img class="c-figure-RomboImage" src="unit_2/module_6/assets/images/objetives.png" alt=""/></div>
          </figure>
        </div>
        <div class="col-flex-md5 col-flex-xs12 col-flex-sm7 col-center">
          <div class="row">
            ...
            <ul class="c-moduleObjetive-description browser-default">
              ...
              <li class="c-moduleObjetive-items">Express actions with phrasal verbs.</li>
              <li class="c-moduleObjetive-items">Express certainty, possibility and doubt.</li>
              <li class="c-moduleObjetive-items">Talk about life in the future.</li>
              <li class="c-moduleObjetive-items">Predict during a conversation.</li>
            </ul>
          </div>
        </div>
      </div>
