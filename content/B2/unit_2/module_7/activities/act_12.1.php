      ...
      <div class="row-flex s-actividad u-animationFadeDown">
        <div class="row-flex align-items-center">
          ...
          <div class="col xs12 md6">
            <div class="col x8 md10 col-center ta-c mt30 mb30"><img class="u-responsive-img m-a" src="unit_2/module_7/assets/img/act_12.png" alt="act_12"/></div>
            <div class="col-center col xs12 md11 lh-20 ta-j"><span>easures taken, we know of accidents that have happened in plants in different countries. Using Linking Words: Talking 12about Nuclear Hazards. There are three separate sources of hazards related to the use of nuclear reactors to supply us with   energy. Firstly, the radioactive material must travel from its place of manufacture to the power station in containers that are not solidly built, </span><strong><span class="u-textColor_4-dark">(1)</span></strong>
              <select name="act_12_1">
              ...
              </select><span> verything they say about them being perfectly safe. Unfortunately, the two normal methods of transport, road or rail, both involve</span>
            </div>
          </div>
          <div class="col xs12 md6">
            <div class="col-center col xs12 md11 lh-20 ta-j"><span>contact with the general public, because the routes are bound to pass near, or even through, highly populated areas. </span><br/><br/><br/><span>Secondly, there is the problem of waste. The waste that all nuclear power stations produce will, in most cases, remain radioactive for thousands of years and cannot be deactivated, so they must be stored. </span><strong><span class="u-textColor_4-dark">(2)</span></strong>
              <select name="act_12_2">
                <option value="" disabled="disabled" selected="selected"> </option>
                <option value="despite">despite</option>
                <option value="although">although</option>
                <option value="in spite of">in spite of</option>
