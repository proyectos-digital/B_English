        ...
        <div class="row-flex">
          <div class="col-flex-sm12 col-flex-md6 col-center">
            <div class="row mt30">
              ...
              <p>In fact, he <strong>(4. have to pay)</strong><span class="c-textField">
              ...
              <p>
                 Peters <strong>(5. work) </strong><span class="c-textField">
              ...
              <div class="row"><img class="u-responsive-img centrado mt20" src="./unit_2/module_5/assets/images/act_2_1.png" alt="" srcset=""/></div>
            </div>
          </div>
          <div class="col-flex-sm12 col-flex-md5 offset-md1 col-center">
            ...
            <div class="row mt30">
              <p>He <strong>(7. try)</strong><span class="c-textField">
              ...
              <p>
                 He <strong>(9. even, sell) </strong><span class="c-textField">
                  <input class="c-input js-escribir" type="text" placeholder="Text here..."/></span>his car.</p>
              <p>
                 The day of the launch and presentation of his book at the International Business Book Fair was a day that he <strong>(10. dream)</strong><span class="c-textField">
                  <input class="c-input js-escribir" type="text" placeholder="Text here..."/></span>of for years.</p>
              <p>He walked proudly into the room which <strong>(11. be scheduled)</strong><span class="c-textField">
                  <input class="c-input js-escribir" type="text" placeholder="Text here..."/></span>for his presentation. </p>
              <p>But, instead of the dozens of people he <strong>(12. expect)</strong><span class="c-textField">
          ...
          <div class="row-flex">
            ...
            <div class="col-flex-sm12 col-flex-md6 col-center">
              <div class="c-wrapTextarea">
                <textarea class="c-textarea h300" placeholder="Write here..."></textarea>
              </div>
            </div>
          </div>
        </div>
