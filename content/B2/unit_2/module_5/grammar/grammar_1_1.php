...
<section class="template-wrapper">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <div class="row">
        <p class="ta-c">
           The <strong>past perfect </strong>can be used to communicate something before the past, or looking back from a past moment in time.</p>
        <div class="row-flex align-items-center mt50">
          ...
          <div class="col-flex-sm12 col-flex-md6 col-center showTo-md"> 
            <div class="row"><img class="u-responsive-img centrado mt30" src="./unit_2/module_5/assets/images/grm_1.png" alt="" srcset=""/></div>
          </div>
        </div>
      </div>
    </section>
