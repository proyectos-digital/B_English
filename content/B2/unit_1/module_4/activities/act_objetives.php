      ...
      <div class="row-flex c-moduleObjetive">
        <div class="col-flex-md7 showTo-md">
          <figure class="c-figure-Rombo">
            <div class="c-figure-RomboRotate"><img class="c-figure-RomboImage" src="unit_1/module_4/assets/images/obj_1.png" alt=""/></div>
          </figure>
        </div>
        <div class="col-flex-md5 col-flex-xs12 col-flex-sm7 col-center">
          <div class="row">
            ...
            <ul class="c-moduleObjetive-description browser-default">
              ...
              <li class="c-moduleObjetive-items">Talk about things that are done.</li>
              <li class="c-moduleObjetive-items">Express emphasis on what is done, in the past.</li>
              <li class="c-moduleObjetive-items">Read and understand movie reviews.</li>
              <li class="c-moduleObjetive-items">Change the direction of a conversation.</li>
            </ul>
          </div>
        </div>
      </div>
