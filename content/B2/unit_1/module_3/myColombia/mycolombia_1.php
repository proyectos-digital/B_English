...
<section class="template-wrapper act_10" ng-init="juegoHangman({ 1:['established','Hangman 1'], 2:['comply','Hangman 2'], 3:['requirements','Hangman 3'], 4:['entertainment industry','Hangman 4'], 5:['committee','Hangman 5'] }, 5); ">
  <aside class="template-asideLeft o-aside-Item"></aside>
  
  <div class="template-section m-a">
    <section class="template-content">
      <h5>Hangman</h5>
      <h6 class="mb20"><strong class="u-textColor_4">1. </strong> You must guess the word before you're hanged!  Use the dictionary to find out the meaning for these words.</h6>
      <div class="row-flex mt10-xs mt10-md">
        <div class="game__hangman mt40 game__hangman1">
          <div class="game__hangman--score">
            ...
            <div class="game__hangman--scoreTotal">5</div>
          </div>
