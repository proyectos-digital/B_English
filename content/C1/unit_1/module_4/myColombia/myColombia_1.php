...
<section class="template-wrapper act_1" ng-init="s_actividad = 1; FuncionForos()">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <div class="row" ng-show="s_actividad == 1">
