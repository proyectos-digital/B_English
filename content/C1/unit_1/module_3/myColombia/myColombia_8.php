  ...
  <div class="template-section m-a" ng-init="MostrarIframe()">
    <section class="template-content u-animationFadeDown">
      <article class="row-flex justify-center">
        <div class="row xs12 md6">
          <div class="col">
            <p>Interview one of your friends or family member about some of their favourite high school memories. Ask about their favourite teacher, subjects and friends..</p>
