  ...
  <div class="template-section m-a">
    <section class="template-content">
      <div class="row row-flex mt30 align-items-center">
        <h5 class="row mb60">Let's talk about education.</h5>
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_1/module_3/assets/videos/test_3_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• What makes a good student?</li>
                <li>• What role should the teacher have in the classroom?</li>
                <li>• Do you think computers will one day replace teachers in the classroom?</li>
                <li>• How has teaching changed in your country in the last few decades?</li>
                <li>• What is the difference between the way children learn and the way adults learn?</li>
                <li>• How can a teacher make lessons for children more interesting?</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod3_test3',1)">
