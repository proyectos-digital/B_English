            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_1/module_1/assets/videos/test_3_1.mp4" type="video/mp4"/>Your browser does not support the audio element.
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• Do you think job satisfaction is more important than salary when choosing a job?</li>
                <li>• What skills do you think are needed to get a good job these days?</li>
                <li>• Do you think women should be able to do all the same jobs that</li>
                <li>• men do?</li>
                <li>• How has technology changed the way we work?</li>
                <li>• What is the difference between white collar and blue collar jobs?</li>
                <li>• What jobs do you think are most valuable to society?</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod1_test1',1)">
