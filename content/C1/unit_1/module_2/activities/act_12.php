...
<section class="template-wrapper act_12" ng-init="s_actividad = 1">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <h5 class="ta-c">Introducing Yourself before Giving a Speech</h5>
      <div class="row mt20 row-flex align-items-center">
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_1/module_2/assets/videos/act_12_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6 ta-c">
          <h6> Now introduce yourself before giving a speech. <br/> Follow the previous model.</h6>
          <div class="row mt20">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod2_act11',1)">
