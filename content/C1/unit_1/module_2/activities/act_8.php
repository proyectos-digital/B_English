  ...
  <div class="template-section m-a">
    <section class="template-content">
      <div class="row-flex align-items-center">
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_1/module_2/assets/videos/act_8_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <h5>Now record your answer to the following question:</h5>
          <p>How would you describe your body language:<br/>conscious and unconscious movements and postures by which your attitudes and feelings are communicated?</p>
          <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod2_act8',1)">
