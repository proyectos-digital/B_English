        ...
        <div class="col xs12 md6">
          ...
          <div class="c-contVideo">
            <video class="u-responsive-video" controls="controls">
              <source src="unit_1/module_2/assets/videos/act_5_1.mp4" type="video/mp4"/>Your browser does not support the audio element.
            </video>
          </div>
        </div>
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="c-listDefault">
                <li>Do you include health or dietary supplements in your health and exercise routines? What are they and what are they supposed to do?</li>
                <li>Is it easy to keep fit where you live?</li>
                <li>What do you think is more important, having a strict diet or using the appropriate health supplements?</li>
                <li>What are the health benefits of playing a sport?</li>
                <li>Have you ever had any habits which you consider to be unhealthy?</li>
                <li>Do you think more about your health now than when you were younger?</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod2_act5',1)">
