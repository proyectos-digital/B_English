            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_1/module_2/assets/videos/self_4_1.mp4" type="video/mp4"/>Your browser does not support the audio element.
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <p>Describe something you do to keep healthy. Talk about:</p>
              <ul class="lh25">
                <li>
                  <h6 class="u-textWhite">• What this activity is?</h6>
                </li>
                <li>
                  <h6 class="u-textWhite">• When you do it?</h6>
                </li>
                <li>
                  <h6 class="u-textWhite">• How often you do it?</h6>
                </li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod2_self5',1)">
