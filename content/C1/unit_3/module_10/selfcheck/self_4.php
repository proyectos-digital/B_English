    ...
    <section class="template-content">
      <div class="row row-flex align-items-center">
        <div class="col xs12 md6">
          <h5>Let’s talk about art.</h5>
          <div class="row-flex justify-center mt30 mb20">
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_3/module_10/assets/videos/self_4_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          ...
          <div class="c-cardGreen mt30">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>Describe a piece of art that you like. You should say:</li>
                <li>• What  the work of art is.</li>
                <li>• When you first saw it.</li>
                <li>• What do you know about it?</li>
                <li>• And explain why you like it.</li>
              </ul><span>Speak for at least 3 minutes</span>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod10_self4',1)">
