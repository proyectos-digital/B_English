...
<section class="template-wrapper col_6">
  ...
  <div class="template-section m-a">
    <section class="template-content u-animationFadeDown">
      <h5>Let’s talk about arts.</h5>
      <div class="row mt20">
        <div class="col xs12 md6">
          <div class="c-contVideo">
            <video class="u-responsive-video" controls="controls">
              <source src="unit_3/module_10/assets/videos/col_6_1.mp4" type="video/mp4"/>
            </video>
          </div>
        </div>
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <p>Please read and answer the following questions. <br/><br/>
                • What’s your favourite form of art? How do you
                consume this art form?<br/>
                • How has art impacted your life? Whether it’s
                paintings sculptures, performing art, street art
                or cinema.<br/><br/>
                Speak not less than 3 minutes.
                
              </p>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unit3_mod10_mycol6',1)">
