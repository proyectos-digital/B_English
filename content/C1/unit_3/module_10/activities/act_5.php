            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_3/module_10/assets/videos/act_5_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          ...
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• Do you like art? (Why? / Why not?)</li>
                <li>• How do you feel about art?</li>
                <li>• What kind of art do you like the most?</li>
                <li>• What kind of art are you best at?</li>
                <li>• Were you exposed to art during your childhood?</li>
                <li>• Did you ever produce any artwork (or, works of art) when you were a child?</li>
              </ul><span>Speak for at least 3 minutes</span>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod10_act5',1)">
