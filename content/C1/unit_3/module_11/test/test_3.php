...
<section class="template-wrapper test_3">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <h5>Let’s talk about science.</h5>
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_3/module_11/assets/videos/test_3_1.mp4" type="video/mp4"/>Your browser does not support the video element.
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="c-list">
                <li>Answer the following questions. Describe an important invention that you think has positively influenced the human race.</li>
                <li>Talk about:</li>
                <li>What the invention is.</li>
                <li>Who invented it?</li>
                <li>What changes has it brought?</li>
                <li>Explain how it has positively influenced the human race.</li>
              </ul>
            </div>
          </div>
          <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod11_test3',1)">
