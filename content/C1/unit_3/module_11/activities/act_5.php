      ...
      <div class="row row-flex mt30 align-items-center">
        <div class="col xs12 md6">
          <div class="row-flex justify-center mb20">
            <div class="col md11 col-center"></div>
          </div>
          <div class="c-contVideo">
            <video class="u-responsive-video" controls="controls">
              <source src="unit_3/module_11/assets/videos/act_5_1.mp4" type="video/mp4"/>Your browser does not support the video element.
            </video>
          </div>
        </div>
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                ...
                <li>• Are you very interested in science?</li>
                <li>• What area of science have you studied (or learned)?</li>
                <li>• Is your work related to science?</li>
                <li>Speak for at leats 3 minutes.</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod11_act5',1)">
