    ...
    <section class="template-content" ng-init="ContadorPalabras(150)">
      <div class="row">
        <div class="col xs12 md6">
          <h6 class="mb20">Investment Report</h6>
          <div class="row-flex justify-center"><img class="max-ancho450 u-responsive-img m-a w80" src="unit_3/module_11/assets/images/col_8_1.png" alt="myColombia"/></div>
        </div>
        <div class="col xs12 md6">
          <h6 class="mb20">Write a report for a university teacher describing the investment in biotechnology shown.</h6>
