        ...
        <div class="col xs12 md6">
          <div class="c-contVideo">
            <video class="u-responsive-video" controls="controls">
              <source src="unit_3/module_9/assets/videos/test_3_1.mp4" type="video/mp4"/>Your browser does not support the video element.
            </video>
          </div>
        </div>
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• When do people wear traditional clothing in your country?</li>
                <li>• How have clothing fashions changed in your country over the last few decades?</li>
                <li>• What is the comparison between what older and younger generations wear?</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod9_test3',1)">
