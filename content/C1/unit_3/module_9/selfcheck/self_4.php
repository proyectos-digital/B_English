            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_3/module_9/assets/videos/self_4_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
          ...
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                ...
                <li>• Can clothing tell you much about a person?</li>
                <li>• Why do some companies ask their staff to wear uniforms?</li>
                <li>• What are the advantages and disadvantages of having uniforms at work?</li>
                <li>• Speak for at least 3 minutes.</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod9_self4',1)">
