...
<section class="template-wrapper act_5">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <h5>Let’s talk about fashion and clothing.</h5>
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_3/module_9/assets/videos/act_5_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
          ...
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                ...
                <li>• Are clothes important to you?</li>
                <li>• What kind of clothes do you usually wear?</li>
                <li>• Do you ever wear the traditional clothes of your country?</li>
                <li>• Where do you usually buy your clothes?</li>
                <li>• Have you ever worn a uniform?</li>
                <li>• Do most people in your country follow fashion?</li>
                <li>• Speak for at least 3 minutes.</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt3_mod9_act5',1)">
