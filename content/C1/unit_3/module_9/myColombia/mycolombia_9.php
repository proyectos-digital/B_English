    ...
    <section class="template-content u-animationFadeDown">
      <article class="row-flex justify-center">
        <div class="row col-flex-xs12 col-flex-md6">
          <div class="col">
            <p class="ta-j">Ask some friends about the traditional Colombian clothes that they own (this could also include the national football jersey).  Ask them when do they wear them and how do they feel when they wear them.</p>
