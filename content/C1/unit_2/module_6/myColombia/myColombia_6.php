        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <p>
                Record your opinion about what
                everyday people can do to help to slow
                climate change. From our individual
                carbon footprint to what the Colombian
          ...
          <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt1_mod6_mycol9',1)">
