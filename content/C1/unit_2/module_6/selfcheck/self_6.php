...
<section class="template-wrapper self_6" ng-init="ContadorPalabras(200)">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <div class="row row-flex mt30">
        ...
        <div class="row mt30">
          <div class="col xs12 md6 ta-c"><img class="u-responsive-img" src="unit_2/module_6/assets/images/self_6_1.png" alt=""/></div>
