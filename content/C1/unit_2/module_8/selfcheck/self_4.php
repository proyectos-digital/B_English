      ...
      <div class="col xs12 md6 mt30">
        <div class="c-contVideo">
          <video class="u-responsive-video" controls="controls">
            <source src="unit_2/module_8/assets/videos/self_4_1.mp4" type="video/mp4"/>
          </video>
        </div>
      </div>
      <div class="col xs12 md6 mt30">
        <div class="c-cardGreen">
          <div class="c-cardGreenContent">
            <ul class="lh25">
              <li> Describe a war movie you like.</li>
              <li>• What’s the difference between the movies on your country and Hollywood movies?</li>
              <li>• What do you think of violent films?</li>
              <li>• Which parts of a movie are the most important?</li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt2_mod8_self4',1)">
