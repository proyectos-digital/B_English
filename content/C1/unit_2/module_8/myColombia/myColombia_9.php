    ...
    <section class="template-content u-animationFadeDown">
      <article class="row-flex justify-center">
        <div class="col-flex-xs12 col-flex-md6">
          <p>Interview someone about their favourite form of entertainment when they were a child in comparison to what it is today.</p>
          <p>Formulate your questions in a way that forces the interview to talk.</p>
          <p>Summarize in English what the interview said in Spanish. Then record yourself in a video reporting what was said by the interview.</p>
          <ul class="row">
