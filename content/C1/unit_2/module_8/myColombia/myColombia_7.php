        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <p>
                Make a comparison between the ways people entertain themselves in Colombia in the 1950s in the 1990s and today. You may need to do a bit of research on the internet.
                <br/><br/>
          ...
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt2_mod8_mycol7',1)">
