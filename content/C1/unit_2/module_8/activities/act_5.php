            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_2/module_8/assets/videos/act_5_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• Do you enjoy watching movies?</li>
                <li>• What’s your favorite movie?</li>
                <li>• Who are your favorite actors?</li>
                <li>• How often do you watch movies?</li>
              </ul>
            </div>
          </div>
          <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt2_mod8_act5',1)">
