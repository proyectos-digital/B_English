            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_2/module_7/assets/videos/self_4_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>Talk about the most important benefit of the internet. Talk about:</li>
                <li>● What is the most importante benefit of the internet?</li>
                <li>● Why is it the most important benefit?</li>
                <li>● How can students take advantage of it? </li>
                <li>● Explain what is the importance of it in your country.</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt2_mod7_self4',1)">
