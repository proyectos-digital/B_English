    ...
    <section class="template-content u-animationFadeDown">
      <article class="row-flex justify-center">
        <div class="col-flex-xs12 col-flex-md6">
          <div class="col">
            <p class="ta-j">Interview someone about what their life would be like without the use of the internet or another technologics. Then ask them what technology they would like to add to there everyday life?</p>
