...
<section class="template-wrapper test_3">
  ...
  <div class="template-section m-a">
    <section class="template-content">
      <h5>Let’s talk about the internet.</h5>
            ...
            <div class="col md11 col-center">
              <div class="c-contVideo">
                <video class="u-responsive-video" controls="controls">
                  <source src="unit_2/module_7/assets/videos/test_3_1.mp4" type="video/mp4"/>
                </video>
              </div>
            </div>
          </div>
        ...
        <div class="col xs12 md6">
          <div class="c-cardGreen">
            <div class="c-cardGreenContent">
              <ul class="lh25">
                <li>• Do most people have a computer at home in your country?</li>
                <li>• Do you think all information on the internet is true?</li>
                <li>• How can people find reliable information on the internet?</li>
                <li>• How has the internet changed the way we live?</li>
                <li>• How has the internet changed the way we work?</li>
                <li>• Do you think the internet is safe for children to use unsupervised?</li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="row c-ngRecorder" ng-audio-recorder="ng-audio-recorder" id="mainAudio_a" time-limit="120" audio-model="audio_1" on-playback-start="guardarRecord('unt2_mod7_test3',1)">
