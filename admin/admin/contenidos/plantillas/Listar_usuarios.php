...
<div ng-controller="controlUsuarios as showCase" ng-show="rowPrincipalLusu">
  <div class="row">
    <div class="col s12 m12 l12">
      <div class="card">
        <div class="card-content"  ng-init="listarusuarios()">
          ...
          <table class="striped responsive-table bordered centered" ng-table="tableusers" datatable="ng" dt-instance="dtInstance">
            ...
            <tbody>
              <tr ng-repeat="usuario in usuarios | filter:buscador">
                ...
                <td>
                  <button class="waves-effect waves-light btn-large blue-btn" ng-class="(usuario.estado == 1) ? 'btn_yellow' : 'btn-danger'" ng-click="activarUsuarios(usuario.id,usuario.estado)">
                    <i class="fa fa-check"></i>
                  </button>

                  <a href="#/editar_usuarios/{{usuario.id}}">
                ...
                <!-- <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button> -->
                  ...
                  <button  type="button" id="btnmod" class="waves-effect waves-light btn-large blue-btn" ng-click="verIdUser(usuario.id)" data-toggle="modal" usuarioid="{{usuario.id}}" data-target="#myModal">
