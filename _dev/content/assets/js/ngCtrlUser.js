...
app.controller('CtrlUser', [
    '$scope', '$state', '$stateParams', 'ngAudio', '$timeout', '$http','funcionesGeneral', 'ApiStatic', 'ApiUserPerfil', 
    function($scope, $state, $stateParams, ngAudio, $timeout, $http, funcionesGeneral, ApiStatic, ApiUserPerfil){
    /**
    ...
    $scope.estadisticasPerfil = function(){
        ...
        ApiUserPerfil.EstadisticaPerf(variables).then(function(data){
            ...
            angular.forEach(respuesta,function(valor) {
                ...
                $scope.correctas =valor.correctas,
                $scope.incorrectas =valor.incorrectas,
                $scope.totalPreg=valor.totalPreg
